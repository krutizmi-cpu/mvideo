...
# ══════════════════════════════════════════════════════════════
# КОМИССИИ (тарифный файл 2025, 3 листа, 894 строки)
# Поиск: Группа Товаров → Планнейм → Подкатегория → Others
# ══════════════════════════════════════════════════════════════
...
COMMISSIONS_BY_GROUP = {
    ...
    "Знак аварийной остановки": 0.205, "Клей для ремонта шин": 0.205,
    "Лопата автомобильная": 0.205, "Накладка для домкрата": 0.205,
    "Наклейка на авто": 0.205, "Страховочная опора": 0.205, "Табличка для авто": 0.205,
    "Трос буксировочный": 0.205, "Упор противооткатный": 0.205,
    "Автомобильный манометр": 0.205, "Ареометр": 0.205,
    "Глубиномер протектора шин": 0.205, "Инструмент для кручения болта": 0.205,
    "Инструмент для чистки клемм": 0.205, "Инструмент запрессовочно-выпресс": 0.205,
    "Ключ баллонный": 0.205, "Ключ динамометрический": 0.205, "Ключ свечной": 0.205,
    "Комплектующие для лебедки": 0.205, "Компрессометр": 0.205,
    "Набор автомобильных инструментов": 0.205, "Набор для ремонта кабеля": 0.205,
    ...
    # Товары для школы / канцелярия
    "Блокнот для флипчартов": 0.235, "Блокнот творческий": 0.235,
    "Бумага для заметок": 0.235, "Бумага для оргтехники": 0.235,
    "Бумага миллиметровочная": 0.235, "Гостевая книга": 0.235,
    "Грамота и диплом": 0.235, "Обложка для документов": 0.235,
    "Анатомическая модель": 0.235, "Банковская резинка": 0.235,
    "Бейдж": 0.235, "Бизнес-набор": 0.235, "Блок": 0.235,
    "Браслет контрольный": 0.235, "Глобус": 0.235, "Грифель": 0.235,
    "Губка для досок": 0.235, "Демосистема": 0.235,
    "Держатель канцелярский": 0.235, "Диспенсер канцелярский": 0.235,
    "Доска для записей": 0.235, "Дырокол": 0.235,
    "Жидкость для снятия этикетки": 0.235, "Зажим канцелярский": 0.235,
    "Закладка": 0.235, "Закладка магнитная": 0.235,
    "Информационная стойка": 0.235, "Калькулятор": 0.235,
    "Канцелярский набор": 0.235, "Клей-карандаш": 0.235,
    "Клейкая лента": 0.235, "Клейкая лента декоративная": 0.235,
    "Клейкие листки": 0.235, "Ластик": 0.235, "Линейка": 0.235,
    "Маркер для доски": 0.235, "Маркер перманентный": 0.235,
    "Маркер текстовый": 0.235, "Ножницы": 0.235, "Ножницы фигурные": 0.235,
    "Нож канцелярский": 0.235, "Нож скрапбукинг": 0.235,
    "Папка": 0.235, "Папка-конверт": 0.235, "Подставка канцелярская": 0.235,
    "Разделитель страниц": 0.235, "Ручка гелевая": 0.235,
    "Ручка капиллярная": 0.235, "Ручка перьевая": 0.235,
    "Ручка роллер": 0.235, "Ручка шариковая": 0.235,
    "Скоба для степлера": 0.235, "Скотч двусторонний": 0.235,
    "Степлер": 0.235, "Точилка": 0.235, "Чехол для ручки": 0.235,
    "Короб почтовый": 0.235, "Пакет почтовый": 0.235, "Почтовая марка": 0.235,
    "Печать для пломбирования": 0.235, "Пломба": 0.235,
    "Пломба-наклейка": 0.235, "Пломбиратор": 0.235,
    "Пломбировочная лента": 0.235, "Проволока пломбировочная": 0.235,
    "Сургуч": 0.235, "Мешок для обуви школьный": 0.235,
    "Пенал": 0.235, "Рюкзак школьный": 0.235,
    ...
    "Гироскутер": 0.005, "Квадроцикл": 0.005, "Мопед": 0.005,
    "Мотоцикл": 0.005, "Мотоцикл электрический": 0.005,
    "Самокат": 0.005, "Электровелосипед": 0.005,
...
def get_ai_category(product_name: str, api_key: str = None) -> tuple[str, float]:
    c = conn.cursor()
...
def find_target_price(cost, logistics, commission_rate, acq_rate, early_rate, tax_type, target_m):
    tax_rate = (
        0.06 if tax_type == "УСН Доходы (6%)"
        else 0.04 if tax_type == "Самозанятый (4%)"
        else 0.20
    )
        ...
        for index, row in df.iterrows():
            try:
                ...
                rec_price = find_target_price(
                    ...
                    acquiring, early_payout, tax_system, target_margin
                )
                ...
                st.error(f"Ошибка строки {index}: {e}")
